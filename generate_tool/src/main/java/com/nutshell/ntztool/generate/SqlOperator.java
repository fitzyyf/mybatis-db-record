...
public class SqlOperator {
    ...
    public static SqlModal createSql(TableInfo tableInfo, String domainName) {
    ...
    private static ColumnInfo createSql(TableInfo tableInfo, StringBuilder insert, StringBuilder proBuilder,
        ...
        for (ColumnInfo columnInfo : tableInfo.getColumnList()) {
            ...
            if (columnInfo.isPri()) {//主键
                ...
                delete.append("         DELETE FROM ").append(tableInfo.getTableName()).append(" WHERE ").append(columnName).append(" = #{").append(clsPro).append("}\n");
